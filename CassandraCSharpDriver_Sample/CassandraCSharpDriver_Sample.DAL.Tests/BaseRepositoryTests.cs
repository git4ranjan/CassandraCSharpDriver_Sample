...
{
    public class BaseRepositoryTestsFixtureData
    {
        public BaseRepositoryTestsFixtureData()
        {
    ...
    public class BaseRepositoryTests : IClassFixture<BaseRepositoryTestsFixtureData>
    {
        ...
        public void PreConditionFailsWhenNotCassandraUnitOfWorkPassedToConstructor()
        {
            ...
            Assert.Throws<ArgumentException>(
                () => { new CassandraRepository<Foo>(new Mock<IUnitOfWork>().Object); });
        }
